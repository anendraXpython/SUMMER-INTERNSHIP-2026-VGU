      ...
      <div className="card-body">
        ...
        {expanded && (
          <div className="details">
            ...
            {fullDetails?.virtualTourUrl && (
              <VirtualTourEmbed url={fullDetails.virtualTourUrl} />
            )}
            ...
            {fullDetails?.walkScoreData && (
              <WalkScoreBadge walkScoreData={fullDetails.walkScoreData} />
            )}

            {fullDetails?.priceHistory && (
              <PriceHistoryChart priceHistory={fullDetails.priceHistory} />
            )}

            {fullDetails?.comparableSales && (
              <ComparableSales comparables={fullDetails.comparableSales} />
            )}
